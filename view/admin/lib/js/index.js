    ...
    $.post(
      ...
      function(retorno) {
        ...
        if (retorno.resposta == "0") {
          ...
          $("#botoes").append(
            "<button id='btn-primeiro-login' class='btn btn-primary btn-block btn-flat' type='button' data-id='" +
              retorno.resposta +
              "'> PRIMEIRO LOGIN </button>"
          );
        } else {
        }
      },
